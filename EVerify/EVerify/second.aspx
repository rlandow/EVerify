...
<head runat="server">
    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            ...
            var DocBTitle = $("#ddlDocBTitle").find("option:selected").val()
            
            if (DocBTitle == "1" || DocBTitle == "2") $("#txtDocBIssuer").hide()
            else $("#ddlDocBIssuer").hide()

            //var test = $("#ddlDocBTitle")
            //alert(test)
            //alert(test2)

            $(".datepicker").css("background-color", "#b0e0e6")

            $("body").on("keypress", (".readonly"), function () {
                return false        
            ...
            $("body").on("focus", ('.readwrite'), function () {
                $(this).css({ 'background': 'white' });
            });

            $("body").on("blur", ('.readwrite'), function () {
        ...
        function docBTitle() {
            //var DocBTitleTest = $("#ddlDocBTitle").find("option:selected").val()
            var docBTitleTest = $("#ddlDocBTitle").find("option:selected").val()
            if (docBTitleTest == "1" || docBTitleTest == "2") {
                $("#txtDocBIssuer").hide()
                $("#ddlDocBIssuer").show()
                $("#ddlDocBIssuer").val("")
            }
        ...
        function docCTitle() {
            var docCTitleTest = $("#ddlDocCTitle").find("option:selected").val()
            if (docCTitleTest == "13") $("#txtDocCIssuer").val("Social Security Adminstration")
            else if (docCTitleTest == "14" || docCTitleTest == "15") $("#txtDocCIssuer").val("U.S. Department of State")
            else if (docCTitleTest == "18" || docCTitleTest == "19") $("#txtDocCIssuer").val("U.S. Immigration and Naturalization Service")
            else if (docCTitleTest == "20") $("#txtDocCIssuer").val("Department of Homeland Security")
            else $("#txtDocCIssuer").val("")
        }

        function none1() {
            $('#ddlDocA1Title option:eq(0)').attr('disabled', true);
        }

        function none2() {
            $('#ddlDocA2Title option:eq(0)').attr('disabled', true);
        }
        ...
        function DocATitleChange() {
            ...
            if ($(target).prop("id") == "ddlDocA1Title") {
                ...
                if ($(target).val() == "") {
                    ...
                    $("#ddlDocA2Title").removeClass()
                    $("#ddlDocA2Issuer").removeClass()
                    $("#txtDocA2Number").removeClass()
                    $("#txtDocA2Date").removeClass()

                    $("#ddlDocA2Title").prop("disabled", true)

                    $("#ddlDocA2Title").addClass("readonly")
                    $("#ddlDocA2Title").css("background-color", "lightgray")

                    $("#ddlDocA2Issuer").prop("disabled", true)
                    $("#ddlDocA2Issuer").css("background-color", "lightgray")
                    $("#ddlDocA2Issuer").addClass("readonly")
                    $("#txtDocA2Issuer").css("background-color", "lightgray")
                    $("#txtDocA2Issuer").addClass("readonly")

                    $("#txtDocA2Number").css("background-color", "lightgray")
                    $("#txtDocA2Number").addClass("readonly")

                    $("#txtDocA2Date").css("background-color", "lightgray")
                    $('#txtDocA2Date').unbind();
                    $("#txtDocA2Date").addClass("readonly")
                    //$('#txtDocA2Date').removeClass('datepicker');
                    //$('#txtDocA2Date').removeClass('hasDatepicker');
                    ...
                    $("#ddlDocA2Title").removeClass()
                    $("#txtDocA2Issuer").removeClass()
                    $("#ddlDocA2Issuer").removeClass()
                    $("#txtDocA2Number").removeClass()
                    $("#txtDocA2Date").removeClass()

                    $("#ddlDocA2Title").prop("disabled", false)
                    $("#ddlDocA2Title").css("background-color", "lightblue")
                    $("#ddlDocA2Title").addClass("readwrite")

                    $("#ddlDocA2Issuer").prop("disabled", false)
                    $("#ddlDocA2Issuer").css("background-color", "lightblue")
                    $("#ddlDocA2Issuer").addClass("readwrite")
                    $("#txtDocA2Issuer").css("background-color", "lightblue")
                    $("#txtDocA2Issuer").addClass("readwrite")

                    $("#txtDocA2Number").addClass("readwrite")

                    $("#txtDocA2Date").addClass("datepicker")
                    $("#txtDocA2Date").css("background-color", "lightblue")

                    $("#txtDocA2Number").off("focus")
                    $("#txtDocA2Number").css({ 'background': '' });

                    if (selectedValue == "11" || selectedValue == "29") $("#txtDocA1Issuer").val("U.S. Department of State")
                    else if (selectedValue == "13") $("#txtDocA1Issuer").val("U.S. Immigration and Naturalization Service")
                    else if (selectedValue == "17") $("#txtDocA1Issuer").val("U.S. Citizenship and Immigration Services")
                    else $("#txtDocA1Issuer").val("")
            ...
            if ($(target).prop("id") == "ddlDocA2Title") {

                if ($(target).val() == "") {

                    $("#ddlDocA1Title option:eq(0)").attr("disabled", false);
                    $('#txtDocA2Issuer').val('');
                    $('#ddlDocA2Issuer').val('');
                    $('#txtDocA2Number').val('');
                    $('#txtDocA2Date').val("");

                    $("#ddlDocA3Title").removeClass()
                    $("#ddlDocA3Issuer").removeClass()
                    $("#txtDocA3Number").removeClass()
                    $("#txtDocA3Date").removeClass()

                    $("#ddlDocA3Title").prop("disabled", true)

                    $("#ddlDocA3Title").addClass("readonly")
                    $("#ddlDocA3Title").css("background-color", "lightgray")

                    $("#ddlDocA3Issuer").prop("disabled", true)
                    $("#ddlDocA3Issuer").css("background-color", "lightgray")
                    $("#ddlDocA3Issuer").addClass("readonly")
                    $("#txtDocA3Issuer").css("background-color", "lightgray")
                    $("#txtDocA3Issuer").addClass("readonly")


                    $("#txtDocA3Number").css("background-color", "lightgray")
                    $("#txtDocA3Number").addClass("readonly")

                    $("#txtDocA3Date").css("background-color", "lightgray")
                    $('#txtDocA3Date').unbind();
                    $("#txtDocA3Date").addClass("readonly")
                    //$('#txtDocA2Date').removeClass('datepicker');
                    //$('#txtDocA2Date').removeClass('hasDatepicker');
                    ...
                    //$("#ddlDocA1Title option:eq(0)").remove();
                    $("#ddlDocA1Title option:eq(0)").attr("disabled", true);
                    $("#ddlDocA3Title").removeClass()
                    $("#ddlDocA3Issuer").removeClass()
                    $("#txtDocA3Number").removeClass()
                    ...
                    $("#ddlDocA3Title").prop("disabled", false)
                    $("#ddlDocA3Title").css("background-color", "lightblue")
                    $("#ddlDocA3Title").addClass("readwrite")

                    $("#ddlDocA3Issuer").prop("disabled", false)
                    $("#ddlDocA3Issuer").css("background-color", "lightblue")
                    $("#ddlDocA3Issuer").addClass("readwrite")
                    $("#txtDocA3Issuer").css("background-color", "lightblue")
                    $("#txtDocA3Issuer").addClass("readwrite")

                    $("#txtDocA3Number").addClass("readwrite")

                    $("#txtDocA3Date").addClass("datepicker")
                    $("#txtDocA3Date").css("background-color", "lightblue")

                    $("#txtDocA3Number").off("focus")
                    $("#txtDocA3Number").css({ 'background': '' });

                    if (selectedValue == "11" || selectedValue == "29") $("#txtDocA2Issuer").val("U.S. Department of State")
                    else if (selectedValue == "13") $("#txtDocA2Issuer").val("U.S. Immigration and Naturalization Service")
                    else if (selectedValue == "17") $("#txtDocA2Issuer").val("U.S. Citizenship and Immigration Services")
                    else $("#txtDocA2Issuer").val("")

                }

            }

            if ($(target).prop("id") == "ddlDocA3Title") {
            
                if ($(target).val() == "") {
                    $("#ddlDocA2Title option:eq(0)").attr("disabled", false);
                    $('#txtDocA3Issuer').val('');
                    $('#ddlDocA3Issuer').val('');
                    $('#txtDocA3Number').val('');
                    $('#txtDocA3Date').val("");
                    ...
                    $("#ddlDocA2Title option:eq(0)").attr("disabled", true);
                    //$("#ddlDocA2Title option:eq(0)").remove();
                    $("#ddlDocA2Title").removeClass()
                    $("#ddlDocA2Issuer").removeClass()
                    $("#txtDocA2Number").removeClass()
                    $("#txtDocA2Date").removeClass()
                    ...
                    if (selectedValue == "11" || selectedValue == "29") $("#txtDocA3Issuer").val("U.S. Department of State")
                    else if (selectedValue == "13") $("#txtDocA3Issuer").val("U.S. Immigration and Naturalization Service")
                    else if (selectedValue == "17") $("#txtDocA3Issuer").val("U.S. Citizenship and Immigration Services")
                    else $("#txtDocA3Issuer").val("")
        ...
        function validityCheckCeritfySignature() {
            ...
            var result = true
            var selectedValueA = $("#ddlDocA1Title").find("option:selected").val()
            var selectedValueA2 = $("#ddlDocA2Title").find("option:selected").val()
            var selectedValueA3 = $("#ddlDocA3Title").find("option:selected").val()
            var selectedValueB = $("#ddlDocBTitle").find("option:selected").val()
            var selectedValueC = $("#ddlDocCTitle").find("option:selected").val()
            var hireDate = $("#txtFirstWorkDate").val()
            
            if ((selectedValueA == "" && selectedValueB == "" && selectedValueC == "")
                || (selectedValueA == "" && (selectedValueB == "" || selectedValueC == ""))) {
                result = false
                $("#dialog").css("background-color", "lightsalmon")
                $("#dialog").css("white-space", "pre-wrap");
                messagetext = "You must select one item from List A or \none item List B and one item form List C."


                showDialog("Documents not selected", messagetext)
            ...
            if (selectedValueA != "") {
                ...
                if ($("#txtDocA1Number").val().trim() == "") {
                    $("#txtDocA1Number").css("background-color", "lightsalmon")
                    OK = false
                }
                
                if ($("#txtDocA1Date").val().trim() == "") {
                    $("#txtDocA1Date").css("background-color", "lightsalmon")
                    OK = false
                }
            ...
            if (selectedValueA2 != "") {
                ...
                if ($("#txtDocA2Number").val().trim() == "") {
                    $("#txtDocA2Number").css("background-color", "lightsalmon")
                    OK = false
                }

                if ($("#txtDocA2Date").val().trim() == "") {
                    $("#txtDocA2Date").css("background-color", "lightsalmon")
                    OK = false
                }
            ...
            if (selectedValueA3 != "") {
                ...
                if ($("#txtDocA3Number").val().trim() == "") {
                    $("#txtDocA3Number").css("background-color", "lightsalmon")
                    OK = false
                }

                if ($("#txtDocA3Date").val().trim() == "") {
                    $("#txtDocA3Date").css("background-color", "lightsalmon")
                    OK = false
                }
            ...
            if (selectedValueB != "") {
                ...
                if (selectedValueB == "1" || selectedValueB == "2") {
                    if ($("#ddlDocBIssuer").find("option:selected").val() == "") $("#ddlDocBIssuer").css("background-color", "lightsalmon")
                    OK = false
                }
                else {
                    if ($("#txtDocBIssuer").val().trim() == "") $("#txtDocBIssuer").css("background-color", "lightsalmon")
                }

                

                if ($("#txtDocBNumber").val().trim() == "") {
                    $("#txtDocBNumber").css("background-color", "lightsalmon")
                    OK = false
                }

                if ($("#txtDocBDate").val().trim() == "") {
                    $("#txtDocBDate").css("background-color", "lightsalmon")
                    OK = false
                }
            ...
            if (selectedValueC != "") {
                ...
                if ($("#txtDocCIssuer").val().trim() == "") $("#txtDocCIssuer").css("background-color", "lightsalmon")
                OK = false
                
                if ($("#txtDocCNumber").val().trim() == "") {
                    $("#txtDocCNumber").css("background-color", "lightsalmon")
                    OK = false
                }

                if ($("#txtDocCDate").val().trim() == "") {
                    $("#txtDocCDate").css("background-color", "lightsalmon")
                    OK = false
                }
            ...
            if (hireDate.trim() == "") {
                $("#txtFirstWorkDate").css("background-color", "lightsalmon")
                OK = false
...
<body>
        ...
        <div id="divListA" class="listA" runat="server"><b>List A
            ...
            <div class="listAitem">Document Title:<br />
                <asp:DropDownList ID="ddlDocA1Title" runat="server" Width="225px" onchange="DocATitleChange()">
                    ...
                    <asp:ListItem Value="17">Employment Authorization Document (Form I-766)</asp:ListItem>
            ...
            <div class="listAitem">Issuing Autority:<br />
                <asp:TextBox ID="txtDocA1Issuer" width="260px" runat="server"></asp:TextBox>
            ...
            <div class="listAitem">Document Title:<br />
                <asp:DropDownList ID="ddlDocA2Title" runat="server" Width="225px" onchange="DocATitleChange()">
                    <asp:ListItem Value="">None</asp:ListItem>
                    <asp:ListItem Value="11">Arrival/Departure Record (Form I-94)</asp:ListItem>
                    <asp:ListItem Value="13">Permanent Resident Card or Alien Registration Receipt</asp:ListItem>
            ...
            <div class="listAitem">Issuing Autority:<br />
                <asp:TextBox ID="txtDocA2Issuer" width="260px" runat="server"></asp:TextBox>
            ...
            <div class="listAitem">Document Title:<br />
                <asp:DropDownList ID="ddlDocA3Title" runat="server" Width="225px" onchange="DocATitleChange()">
                    <asp:ListItem Value="">None</asp:ListItem>
                    <asp:ListItem Value="11">Arrival/Departure Record (Form I-94)</asp:ListItem>
                    <asp:ListItem Value="13">Permanent Resident Card or Alien Registration Receipt</asp:ListItem>
                    <asp:ListItem Value="17">Employment Authorization Document (Form I-766)</asp:ListItem>
            ...
            <div class="listAitem">Issuing Autority:<br />
                <asp:TextBox ID="txtDocA3Issuer" width="260px" runat="server"></asp:TextBox>
            ...
            <div class="docAB" >
                <div class="list">List B
                    ...
                    <div class="listAitem" style="border-top:1px solid black;">Document Title:<br />
                        <asp:DropDownList ID="ddlDocBTitle" runat="server" onchange="docBTitle()">
                            <asp:ListItem Value="">None</asp:ListItem>
                    ...
                    <div class="listAitem">Issuing Autority:<br />
                        <asp:TextBox ID="txtDocBIssuer" runat="server"></asp:TextBox>
                ...
                <div class="listC" >List C
                    ...
                    <div class="listAitem" style="  border-top:1px solid black;">Document Title:<br />
                        <asp:DropDownList ID="ddlDocCTitle" runat="server" Width="250px" onchange="docCTitle()">
                            <asp:ListItem Value="">None</asp:ListItem>
                    ...
                    <div class="listAitem">Issuing Autority:<br />
                        <asp:TextBox ID="txtDocCIssuer" Width="200px" runat="server"></asp:TextBox>
    ...
    <div class="header-container">
        <div style="width:80%;display:flex;justify-content:space-between;align-items:center">
            <div>
                <img id="logo" src="/Images/WH_I9Logo.jpg" height="46" style="margin-top:2px" />
            </div>
